...
print('--- Multiple Statements in If Block ---')
"""
...
print("--- Using Variables in Conditions ---")
"""
...
username = ""
display_name = username if username else "Karo"
print("Welcome,", display_name)

print('------------------------------')

print('--- When to Use Shorthand If ---')
"""
...
print('--- Nested If vs Logical Operators ---')
"""
...
print('--- pass with Multiple Conditions ---')
"""
